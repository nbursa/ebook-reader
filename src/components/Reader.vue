...
export default {
  ...
  data() {
    return {
      ...
      hiddenEl: false,
      HC: true,
      brandReaderUrl: "https://www.arcadiapublishing.com",
      brandLogoUrl:
        "https://s3.amazonaws.com/textcafe.epubs/brand_logos/Arcadia_Logo.png"
    };
  },
  created: function() {
  ...
  updated() {
    ...
    //   var that = this;
    //   // console.log(links[i].href.split("#")[0]);
    //   if (links[i].href.split("#")[0] === "http://localhost:8080/") {
    //     // if (links[i].href.split("#")[0] === "https://localhost:3000/books/32CsH9/?1496225701835" + this.$route.path) {
    //     links[i].style.textDecoration = "underline";
    //     links[i].style.textDecorationStyle = "dotted";
    //     links[i].onclick = function(e) {
    //       e.preventDefault();
    //       var refr = this.href.split("#")[1];
    //       that.linkTo(refr);
    //     };
    //   }
    // }
  ...
  methods: {
    ...
    //   // console.log('page width ' + (page.offsetWidth + gap))
    //   // console.log('on start ' + onStart)
    ...
    //     elementOffset / (page.offsetWidth + gap)
    //   );
    //   console.log("dest offset" + destinationOffset);
    //   var target = destinationOffset * (page.offsetWidth + gap);
      
    //   if (destinationOffset !== this.pageNumber) {
    //     this.scrollIt(target, 300, "easeOutQuad", false);
    //     const scrollArea = page.scrollWidth - page.offsetWidth;
    //     var pctScrolled = Math.floor(
    //       destinationOffset * (page.offsetWidth + gap) / scrollArea * 100
